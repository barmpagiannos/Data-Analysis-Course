...
% Pros8esame th metavlhth preTMS kai afairesame th metavlhth Spike.
...
xM=T(:,[3,5:end]);% epeleje ta dedomena twn 6 anejartitwn metablhtwn.
...
% NOTES
% 
% Full Model adjR^2=0.3838 - MSE=90.24
...
MSE_sw = mdl_sw.MSE; % Vriskoume MSE
...
% NOTES
% 
% StepWise (SW) Model adjR^2=0.5217 - MSE=70.04
...
% NOTES
%
% LASSO adjR^2=0.7440 - MSE=51.99 - Me Spike
% LASSO adjR^2=0.3727 - MSE=99.56 - Xwris Spike  - 10 CV
...
% % NOTES
% %
% % PCR Model adjR^2=0.3353 - MSE=91.61
...
% SYMPERASMA: To stepwise montelo exei to megalytero adjR2 kai to mikrotero
% MSE, ara einai to kalutero montelo. 
% Nai, sigoura veltiw8hke h prosarmogh tou montelou se sxesh me to erwthma 6 
% kathws plewn to stepwise dinei kalutera apotelesmata.
% To montelo PCR einai to xeirotero apo ta ypoloipa dioti exei to mikrotero
% syntelesth adjR2 kai to megalytero sfalma MSE.


% NOTES
%  Se auto to zhthma xhsimopoihsame kai thn metavlhth preTMS.
%  
%
% % --------------------Results--------------------
% % Full Model 		  MSE: 90.24 	 adjR2: 0.384 
% % StepWise Model 	  MSE: 70.04 	 adjR2: 0.522 
% % LASSO Model 	  MSE: 101.47 	 adjR2: 0.372 
% % --------------------end-------------------------
% % SpikeOut=1  ............  NanOut=0 
% % 
% % 
% % --------------------Results--------------------
% % Full Model 		  MSE: 41.06 	 adjR2: 0.366 
% % StepWise Model 	  MSE: 28.04 	 adjR2: 0.567 
% % LASSO Model 	  MSE: 49.88 	 adjR2: 0.744 
% % --------------------end-------------------------
% % SpikeOut=0  ............  NanOut=0 
% % 
% % 
...
% % Full Model 		  MSE: 41.06 	 adjR2: 0.366 
% % StepWise Model 	  MSE: 28.04 	 adjR2: 0.567 
% % LASSO Model 	  MSE: 50.57 	 adjR2: 0.294 
% % --------------------end-------------------------
% % SpikeOut=0  ............  NanOut=1 
