...
data=T((TMS==1),:); % Epilogh mono me TMS stoixeia
...
% einai megaluteros kai h diaspora twn sfalmatwn einai mikroterh, ara to
% montelo vhmatikhs palindromhshs prosarmozetai kalutera apo oti to plhres
% montelo.
...
% SYMPERASMA: To lasso montelo exei to mikrotero adjR2 syntelesth kai th
% megaluterh diaspora sfalmatwn, ara einai to xeirotero apo ta montela. 

% Xwris th metavlhth SPIKE ta apotelesmata einai safws diaforetika, kai gia
% thn timh tou syntelesth adjR2 kai gia th diaspora twn sfalmatwn.

% Xwris th metavlhth spike, to montelo stepwise einai to kalutero.
