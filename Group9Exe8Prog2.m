...
% Pros8esame th metavlhth preTMS kai kaname kai methodo PCR Regression.
...
% Epilogi twn protwn k synistoswn pou ejhgoun to 95%
...
fprintf('PCR Model \t\t  MSE: %.2f \t adjR2: %.3f \n', MSE_pcr,adjR2_pcr);
fprintf('--------------------end-------------------------\n');
fprintf('SpikeOut=%d  ............  NanOut=%d \n\n',spikeout,NanOut);

% SYMPERASMA: Kai pali to stepwise montelo exei thn kalyterh epidosh, afou
% exei to megalytero adjR2 kai to mikrotero MSE.
...
% % LASSO Model 	  MSE: 104.09 	 adjR2: 0.373 
% % PCR Model 		  MSE: 113.31 	 adjR2: 0.178 
% % --------------------end-------------------------
% % SpikeOut=1  ............  NanOut=0 
% % 
% % --------------------Results--------------------
...
% % LASSO Model 	  MSE: 52.90 	 adjR2: 0.336 
% % PCR Model 		  MSE: 41.58 	 adjR2: 0.300 
% % --------------------end-------------------------
% % SpikeOut=0  ............  NanOut=1 
% % 
% % DEN MPOREI TO PCR NA DIAXEIRISTEI TIS NaN TIMES !!!!
% % --------------------Results--------------------
% % Full Model 		  MSE: 41.06 	 adjR2: 0.366 
% % StepWise Model 	  MSE: 28.04 	 adjR2: 0.567 
% % LASSO Model 	  MSE: 50.79 	 adjR2: 0.744 
% % PCR Model 		  MSE: NaN	 	 adjR2: 1.000   <-----
% % --------------------end-------------------------
% % SpikeOut=0  ............  NanOut=0 
